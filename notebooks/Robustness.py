...
#
# with open("new_outputs/data_robustness_100runs.pkl", "wb") as open_file:
#     pickle.dump(Data_robustness, open_file)
with open("new_outputs/data_robustness_100runs.pkl", "rb") as open_file:
...
gpu_IEKS_std_par_ell = func(gpu_IEKS_std_par, one_T, Data_robustness, sqrt=False)
divergence_rate_extended_std_par_ell = np.mean(np.isnan(gpu_IEKS_std_par_ell), axis=1)*100


gpu_IEKS_sqrt_par_ell = func(gpu_IEKS_sqrt_par, one_T, Data_robustness, sqrt=True, mth="extended_sqrt")
